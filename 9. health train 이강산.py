...
# 처리할 CSV 파일 리스트
files = [
    "C:/Pyth/Intro to BigData/빅개 중간 데이터/국민건강보험공단_건강검진정보_2023.CSV",
]
...
def remove_outliers(df):
    ...
    if df_cleaned.shape[0] == 0:
        print("⚠️ Warning: 이상치 제거 후 데이터가 0개가 되었습니다. 원본 유지합니다.")
        return df
    return df_cleaned
